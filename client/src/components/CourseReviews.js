              ...
              <div className="review-card your-review-card">
                ...
                <div className="review-actions">
                  <button className="btn-edit" onClick={handleEditClick}>
                    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginRight: '4px', verticalAlign: 'middle' }}>
                  ...
                  <button className="btn-delete" onClick={handleDelete}>
                    <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" style={{ marginRight: '4px', verticalAlign: 'middle' }}>
